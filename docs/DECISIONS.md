...
**Decision**: Port defined in `package.json` start script: `npx @11ty/eleventy --serve --port=8086`.

**Ports**: pamphlet=8086, chapbook=8082, folio=8084
